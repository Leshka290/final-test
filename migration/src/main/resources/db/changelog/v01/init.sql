...
COMMENT ON COLUMN restaurants.payment IS 'Номер оплаты';
...
COMMENT ON TABLE order_items IS 'Товары';
COMMENT ON COLUMN order_items.item_id IS 'Номер товара';
COMMENT ON COLUMN order_items.description IS 'Описание товара';
COMMENT ON COLUMN order_items.name IS 'Название товара';
COMMENT ON COLUMN order_items.price IS 'Цена товара';
COMMENT ON COLUMN order_items.quantity IS 'Количество товаров';
